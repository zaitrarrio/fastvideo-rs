...
//!
//! Official sources:
//! - paper arXiv:2602.01077 Algorithm 1 (exact selected blocks, zeroth-order
//!   remainder) and the video note that covariance-aware scoring is image-only
...
/// zeroth-order (paper eqs. for D/N, same multiplicity as Sol).
