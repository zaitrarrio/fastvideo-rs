...
pub fn arch_from_transformer_config(cfg: &Flux1ArchConfig, raw: &str) -> Result<Flux1ArchConfig, String> {
...
mod tests {
    ...
    fn parses_flux1_dev_config_json() {
        ...
        let cfg = arch_from_transformer_config(&Flux1ArchConfig::tiny(), raw).unwrap();
