...
fn gen(
    ...
    let timings = |out: &H3Output, total: f64| {
        ...
        json!({
            ...
            "video_encode_s": t.video_encode_s,
            "write_s": t.write_s,
...
fn h3_benchmark(b: &H3Bench<'_>) -> serde_json::Value {
    ...
    let doc = json!({
        ...
        // PNG frames are written after the mp4, outside the timed numbers.
        "total_s": b.total - t.write_s,
        "inference_time_s": b.total - t.write_s,
        "e2e_seconds": b.total - t.write_s,
        "generate_wall_s": b.total,
